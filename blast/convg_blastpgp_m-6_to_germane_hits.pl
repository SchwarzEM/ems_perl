...
# 
# Erich Schwarz <emsch@its.caltech.edu>, 4/01/03
#
...
unless ($#ARGV == 2) 
{
    ...
    print "  1e-04) that will be put into single-pass gapped-blast scripts.\n";
    print "\n";
    print "What E value is to be used?  ";
    $e_value = <STDIN>;

    print "\n";
    print "  This also requires, as input, a numerical H value (e.g. 1e-03 or\n";
    print "  1e-04) that will be put into iterated psi-blast scripts.\n";
    print "\n";
    print "What H value is to be used?  ";
    $h_value = <STDIN>;
}
else
{
...
until ($i == ($#significant_gi_numbers+1))  
{
    ...
    print ROUGH_BLAST_SCRIPT "-a 2 ";		# -a  Number of processors to use (1 or more)
    print ROUGH_BLAST_SCRIPT "-I T ";		# -I  Show GI's in deflines? (T/F)
    print ROUGH_BLAST_SCRIPT "-h $h_value ";	# -h  e-value threshold for inclusion in multipass model [default 0.005]
    ...
    print ROUGH_BLAST_SCRIPT "$h_value";
    print ROUGH_BLAST_SCRIPT ".align-6 ";
...
print BLAST_SCRIPT "#     with a cutoff E value of $e_value.\n";
print BLAST_SCRIPT "# \n";
...
until ($i == ($#significant_gi_numbers+1))  
{
    ...
    print ROUGH_BLAST_SCRIPT "-i $fasta_gi_segment ";	# -i  Query File
    print ROUGH_BLAST_SCRIPT "-o $fasta_gi_segment";	# -o  Output File for Alignment
        print ROUGH_BLAST_SCRIPT ".psi-blast-x1.ensembl.genscan.fa_";
        print ROUGH_BLAST_SCRIPT "$e_value";
        print ROUGH_BLAST_SCRIPT ".align-6 ";
    print ROUGH_BLAST_SCRIPT ";\n";
}
...
until ($i == ($#significant_gi_numbers+1))  
{
    ...
    print ROUGH_BLAST_SCRIPT "-i $fasta_gi_segment ";	# -i  Query File
    print ROUGH_BLAST_SCRIPT "-o $fasta_gi_segment";	# -o  Output File for Alignment
        print ROUGH_BLAST_SCRIPT ".psi-blast-x1.mouse_genscan.pep_";
        print ROUGH_BLAST_SCRIPT "$e_value";
        print ROUGH_BLAST_SCRIPT ".align-6 ";
    print ROUGH_BLAST_SCRIPT ";\n";
}
