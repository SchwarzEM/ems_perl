...
# script_spec_psi-blast-x01.pl
# Erich Schwarz <emsch@its.caltech.edu>, 12/04/02

# Purpose: generate, from lists of sequences and protein databases, scripted gapped-BlastPs for each versus each.
...
foreach $indiv_database (@database) 
{
    ...
    while (<SEQ_LIST>) 
    {
        chomp ($input_sequence = $_);
        {
            ...
            print BLAST_SHELL "-j 1 -v 1000 -b 1000 -i ";
            print BLAST_SHELL "$input_sequence";
            print BLAST_SHELL " -m 6";
            print BLAST_SHELL " -o ";
            print BLAST_SHELL "$input_sequence";
            print BLAST_SHELL ".psi-blast-x01.";
            print BLAST_SHELL "$indiv_database";
            print BLAST_SHELL "_";
            print BLAST_SHELL "$threshold";
            print BLAST_SHELL " ;\n";
