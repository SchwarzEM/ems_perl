...
my $workdir = '/mnt/ls15/scratch/users/emsch/2016/caenogens/blast2go';
...
foreach my $i (1..$limit) {
    ...
    my $job1 = "job_iprscan_nigoni_2016.12.01.$file_no.sh";
    my $job2 = "job_iprscan_nigoni_2016.12.01.$next_file_no.sh";
