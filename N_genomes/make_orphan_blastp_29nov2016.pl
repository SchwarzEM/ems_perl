...
print '#PBS -l walltime=048:00:00', "\n";
print '#PBS -l nodes=1:ppn=8', "\n";
print '#PBS -l mem=64gb', "\n";
print "#PBS -N job_orphan_blastp_2016.11.29.01.sh\n";
print '#PBS -q main', "\n";
...
foreach my $input (@inputs) {
    my $output = "$input.blastp_E.1e-03.no_seg.orthfind_9spp_2016.11.05.proteome.tsv.txt";
    $output    = safename($output);

    print "blastp -num_threads 8 -outfmt '6 qseqid sseqid evalue'";
    print " -evalue 1e-03 -seg no ";
    print " -db /mnt/ls15/scratch/users/emsch/2016/caenogens/orthofinder/dbs/orthfind_9spp_2016.11.05.01.proteome";
