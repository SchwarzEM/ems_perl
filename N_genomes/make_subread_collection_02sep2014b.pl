...
foreach my $strain (@strains) { 
    ...
    my $output  = "$species.$strain.PacBio_02sep2014.subreads.fastq";
...
while (my $input = <>) {
    chomp $input;
    # Sample input:
    # /mnt/home/emsch/work/Ngen/pacbio/meyer/DF5081/E01_1/Analysis_Results/m120622_115256_42134_c100359792550000001523028310041207_s1_p0.subreads.fast1
    if ( $input =~ /\A \/mnt\/home\/emsch\/work\/Ngen\/pacbio\/meyer\/ ([^\s\/]+) \/ [^\s\/]+ \/ Analysis_Results \/ [^\s\/]+ \.subreads\.fastq \z/xms ) { 
        my $strain = $1;
