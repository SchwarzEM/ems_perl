...
my $header = "Gene\tMap_status";

if ( (! $list ) or (! $gff ) or (! $map_target ) ) {
    die "Format: lifton_gff_genes_13feb2026.pl [input gene list] [GFF3] [mapped genome] > [table of mapped genes]\n";
}
