...
foreach my $k (0..5) {
        ...
        $j = sprintf ("%02u", $i);
        my $chr     = $chrs[$k];
        my $out_vcf = "Necator_2022.05.29.02.chrs.ngm.8_genos.$chr.naive.fb02.vcf";
        ...
        print $SCRIPT ' --haplotype-length 0 --min-alternate-count 1 --min-alternate-fraction 0 --pooled-continuous --report-monomorphic -g 200';
