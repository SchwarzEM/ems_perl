...
foreach my $input_file (@input_files) {
    if ( $input_file =~ /\A Acey_2012\.10\.24\.pgene_log10\.(\S+)_24mar2013\.txt \z/xms ) { 
        ...
        my $qsub_script = 'job_wilcox_SIAP1_motifs_log.' . $stem . '_' . '24apr2013b.sh';
        ...
        print $SCRIPT "wilcoxon_gene_annots.pl -a $motif_table -r $input_file",
                      ' 1>', "Acey_2012.10.24.SIAP1_motifs_wilcoxon_log10.$stem", "_24apr2013b.txt",
                      ' 2>', "Acey_2012.10.24.SIAP1_motifs_wilcoxon_log10.$stem", "_24apr2013b.err",
                      " ;\n",
                      ;
