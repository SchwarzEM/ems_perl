...
while ( my $read_1 = <> ) {
    ...
    print ' --index $PROJECT/Acey/2025.04.01/dbs/Tmuris_WBPS19_gentrome_index';
    print ' --libType A';
    print " --mates1 $read_1";
    print " --mates2 $read_2";
    print " --output $tag.salmon";
    print ' --geneMap $PROJECT/Acey/2025.04.01/annots/trichuris_muris.PRJEB126.WBPS19.cds2gene.tsv.txt ;';
    print "\n";
}
