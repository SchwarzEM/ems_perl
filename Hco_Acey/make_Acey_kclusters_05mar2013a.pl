...
foreach my $k_val (@k_vals) { 
    my $script = 'job_05mar2013_Acey_pme_TPM.5plus_reads.k' . $k_val . '.05mar2013a.sh' ;
    ...
    print $SCRIPT '#PBS -N job_05mar2013_Acey_pme_TPM.5plus_reads.k', $k_val, '.05mar2013a.sh', "\n", ;
    ...
    print $SCRIPT 'cluster -f tpm_records/Acey_pme_TPM.5plus_reads.25feb2013.pzero_TPMs.txt -l -g 7 -k ', 
                  $k_val, 
                  ' -r 1000 -u Acey.05mar2013a.k', 
                  "$k_val ;\n", 
                  ;
