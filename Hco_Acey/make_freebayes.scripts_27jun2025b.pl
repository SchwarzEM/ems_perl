...
foreach my $k (0..5) {
        ...
        my $out_vcf = "Necator_2022.05.29.02.chrs.ngm.8_genos.$chr.naive.fb03.vcf";
        ...
        print $SCRIPT " --report-monomorphic -g 200 --targets necator_aroian_2024.02.08.$short_chr.CDSes.cols1-3.bed";
