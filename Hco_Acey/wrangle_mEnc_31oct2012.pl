...
foreach my $stage (@stages) {
    ...
    print "    zcat @inputs > $stage.modencode.varied_nt_31oct2012.se.fq ;\n";
    print "    gzip -9 $stage.modencode.varied_nt_31oct2012.se.fq ;\n";
    print "    e_ping -p $stage.modencode.varied_nt_31oct2012.se.fq_is_done ;\n";
    print "\n";
}

print "    e_ping -p all_stagesmodencode.varied_nt_31oct2012.se.fq_are_done ;\n\n";
