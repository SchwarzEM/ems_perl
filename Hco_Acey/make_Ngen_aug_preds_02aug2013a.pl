...
foreach my $gen_stem (@genome_stems) { 
    ...
    print $SCRIPT 'augustus --strand=both --genemodel=partial --singlestrand=false',
                  ...
                  ' --progress=true',
                  ' --outfile=', "$gen_stem.aug $gen_stem.fa ;\n",
                  ;
