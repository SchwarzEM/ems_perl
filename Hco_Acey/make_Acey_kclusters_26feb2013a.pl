...
foreach my $k_val (@k_vals) { 
    my $script = 'job_26feb2013_Acey_pme_TPM.5plus_reads.k' . $k_val . '.26feb2013a.sh' ;
    ...
    print $SCRIPT '#PBS -N job_26feb2013_Acey_pme_TPM.5plus_reads.k', $k_val, '.26feb2013a.sh', "\n", ;
    ...
    print $SCRIPT 'cluster -f Acey_pme_TPM.5plus_reads.25feb2013.pzero_TPMs.txt -l -g 7 -k ', 
                  $k_val, 
                  ' -r 1000 -u Acey.26feb2013a.k', 
                  "$k_val ;\n", 
                  ;
