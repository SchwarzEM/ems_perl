...
foreach my $input_file (@input_files) {
    if ( $input_file =~ /\A Acey_2012\.10\.24\.pgene_log10\.(\S+)_24mar2013\.txt \z/xms ) { 
        ...
        my $qsub_script = 'job_wilcox_ASPR_motifs_log.' . $stem . '_' . '19apr2013.sh';
        ...
        print $SCRIPT "wilcoxon_gene_annots.pl -a $motif_table -r $input_file",
                      ' 1>', "Acey_2012.10.24.ASPR_motifs_wilcoxon_log10.$stem", "_19apr2013.txt",
                      ' 2>', "Acey_2012.10.24.ASPR_motifs_wilcoxon_log10.$stem", "_19apr2013.err",
                      " ;\n",
                      ;
