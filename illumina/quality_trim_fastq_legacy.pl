...
# quality_trim_fastq_legacy.pl -- Erich Schwarz <emsch@its.caltech.edu>, 1/24/2011.
# Purpose:  [Old version, vintage 1/24/2011, kept around in case I need to reproduce past FASTQ filtering commands.]  Take four lines at a time.  Print only, as chosen: all but last (unreliable) residue; residues up to maximum length; residues up to last non-N; residues >= quality threshold; residues >= minimum length.  NOTE: assumes 2010 Solexa quality scores (not older-style ones).
