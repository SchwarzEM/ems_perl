...
# faNs2ncbi_20sep2010.pl -- Erich Schwarz <emsch@its.caltech.edu>, 9/20/2010.  LEGACY: kept for back-compatibility, reproducibility of past work.
    ...
    if ( $contig_number >= 2 ) {
        foreach my $i (1..$contig_number) {
            ...
            if ($contigs) {
                ...
                my $contig_name = $seq_name2 . '_' . $contig_tag;
