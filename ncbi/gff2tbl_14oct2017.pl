...
# gff2tbl_11oct2017.pl -- Erich Schwarz <ems@emstech.org>, 10/11/2017.
# Purpose: given a GFF3-like file from AUGUSTUS, export a gene feature table file acceptable to NCBI Sequin; 
...
foreach my $source_seq (@source_seqs) {
    ...
    foreach my $gene_id (@genes) { 
        ...
        foreach my $tx_id (@txs) { 
            ...
            my $product_desc   = "hypothetical $gene_id protein";   # was formerly "$protein_name";
