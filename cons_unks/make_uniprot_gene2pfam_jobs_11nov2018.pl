...
my @inputs2 = qw(
    ../pfam_idmappings/arabidopsis_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/dictyostelium_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/drosophila_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/elegans_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/human_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/mouse_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/pombe_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/pristionchus_uniprot2pfam.alt.tsv.txt
    ../pfam_idmappings/yeast_uniprot2pfam.alt.tsv.txt
...
foreach my $i (@vals) {
    ...
    print ' 1>';
    print "$taxa[$i]"; 
    print "_gene2pfam_11nov2018.tsv.txt";
    print ' 2>';
    print "$taxa[$i]"; 
    print "_gene2pfam_11nov2018.err ;\n";
}
