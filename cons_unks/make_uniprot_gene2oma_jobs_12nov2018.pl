...
my @inputs2 = qw(
    ../uniprot_idmappings/arabidopsis_uniprot2oma.tsv.txt
    ../uniprot_idmappings/dictyostelium_uniprot2oma.tsv.txt
    ../uniprot_idmappings/drosophila_uniprot2oma.tsv.txt
    ../uniprot_idmappings/elegans_uniprot2oma.tsv.txt
    ../uniprot_idmappings/human_uniprot2oma.tsv.txt
    ../uniprot_idmappings/mouse_uniprot2oma.tsv.txt
    ../uniprot_idmappings/pombe_uniprot2oma.tsv.txt
    ../uniprot_idmappings/pristionchus_uniprot2oma.tsv.txt
    ../uniprot_idmappings/yeast_uniprot2oma.tsv.txt
    ../uniprot_idmappings/zebrafish_uniprot2oma.tsv.txt
);

my $input3 = '../oma_idmappings/oma.pooled_acc2name_12nov2018.txt';
...
foreach my $i (@vals) {
    ...
    print ' 1>';
    print "$taxa[$i]"; 
    print "_gene2oma_12nov2018.tsv.txt";
    print ' 2>';
    print "$taxa[$i]"; 
    print "_gene2oma_12nov2018.err ;\n";
}
