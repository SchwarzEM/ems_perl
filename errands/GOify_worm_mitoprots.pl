...
# GOify_worm_mitoprots.pl
# 
# Erich Schwarz, 1/30/02
# 
# Purpose: make GO-format files from a (static!) set of predicted mitochondrial
#          proteins by Marcotte et al.
...
{
    print "\n";
    print "Please name the mitochondrial protein hitlist\n";
    print "    from Marcotte et al. to use (one line per sequence).\n";
    print "The default is \"marcotte-hitlist\": ";
    $marcotte_hitlist=<STDIN>;
    chomp($marcotte_hitlist);
    unless ($marcotte_hitlist =~ /\w+/)
    {
        $marcotte_hitlist = "marcotte-hitlist";
    }
...
print "\n";
print "The Marcotte mitochondrial hitlist will be:    $marcotte_hitlist\n";
...
open (MARCOTTE_HITLIST, "$marcotte_hitlist") 
...
#     Column  6: PUBMED:...  [I.e., Marcotte et al. mito. prot. reference.]
...
while (<MARCOTTE_HITLIST>) 
{
    ...
    print ROUGH_GENE_ASSOC "GO:0005739";         # Hard-wired for this particular output:
    print ROUGH_GENE_ASSOC "\t";                 # "mitochondrion ; GO:0005739"

    # Print "DB:Ref" (6th) column.
    print ROUGH_GENE_ASSOC "PUBMED:11035803";    # Hard-wired for this particular output: 
    print ROUGH_GENE_ASSOC "\t";                 # PUBMED:11035803 -- Marcotte et al. (2000), PNAS 97, 12115-12120.
    ...
    print ROUGH_GENE_ASSOC "C";    # In this case, it's an automatic "C".
    print ROUGH_GENE_ASSOC "\t";
