...
while (my $infile = <>) {
    chomp $infile;
    # Sample input line:
    # RSEM_4nt_results_2016.01.22/rsem_atml1_3_rep1.trim_exact4nt_2016.01.21.24.genes.results
    if ( $infile =~ /\A RSEM_4nt_results_2016\.01\.22\/rsem_ (\S+) \.trim_exact4nt_2016\.01\.21\.\d{2}\.genes\.results \z/xms) {
        my $orig_tag = $1;
        my $tag      = $orig_tag;
        ...
        $outfile     =~ s/RSEM_4nt_results_2016.01.22/RSEM_4nt_results_2016.01.22_subtables/;
