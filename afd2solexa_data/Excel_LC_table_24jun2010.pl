...
# Excel_LC_table_24jun2010.pl -- Erich Schwarz <emsch@its.caltech.edu>, 6/24/2010.
# Purpose: make a TSV file of four RPKM values and their ratios (absolute and log[10]); do *not* round stuff to '0.00'.
