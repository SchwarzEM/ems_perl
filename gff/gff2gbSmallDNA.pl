...
# gff2gbSmallDNA.pl -- originally from http://bioinf.uni-greifswald.de/augustus/binaries/scripts/gff2gbSmallDNA.pl
# Downloaded by Erich Schwarz <ems@emstech.org> on 2/8/2014; slightly edited to get '#!/usr/bin/env perl' header.
