...
# gtf2gff_stanke.pl -- originally from http://bioinf.uni-greifswald.de/augustus/binaries/scripts/gtf2gff.pl
# Downloaded by Erich Schwarz <ems@emstech.org> on 2/8/2014; slightly edited to get '#!/usr/bin/env perl' header; renamed to avoid confusion with gtf2gff3 script.
